...
namespace LWF {
    public static class Extensions {
        ...
        public static void SceneChangeFade(this CanvasGroup canvas, float desiredAlpha, float transitionTime) {
            LeanTween.alphaCanvas(canvas, desiredAlpha, transitionTime).setOnComplete(() => {
                Debug.Log($"Invoking onFadeCompleteAction");
                LevelChanger.Instance.onFadeCompleteAction.Invoke();
            });
    ...
    public static class SaveLoadManager {
        ...
        public static void CreateDefaultFile() {
            ...
            playerSettings.graphicContentEnabled = playerSettings.continuousTurn = true;
