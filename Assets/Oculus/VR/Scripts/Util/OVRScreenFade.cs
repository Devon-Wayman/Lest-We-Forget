...
// TODO: Changes for Devon to make to this script for best use case for LWF
// 		. Have a delay of 0.5 - 1 second after Start is called before beginning fade. Could also fade in master volume here
//		. Change singleton pattern to the one used by Jordan and I instead of just this "instance = this" setup 
public class OVRScreenFade : MonoBehaviour {
    ...
    /// </summary>
    [SerializeField] private int renderQueue = 5000; // Originally just public. Modded by Devon
