...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Home"",
                    ""type"": ""Button"",
                    ""id"": ""4403226b-3227-49ec-ac3e-7376bf9549c9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""4ca0cfcb-1ac0-4cf6-8f83-458a01c1886e"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_Home = m_XRILeftHand.FindAction("Home", throwIfNotFound: true);
        // XRI RightHand
    ...
    private readonly InputAction m_XRILeftHand_Home;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @Home => m_Wrapper.m_XRILeftHand_Home;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @Home.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHome;
                @Home.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHome;
                @Home.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnHome;
            }
